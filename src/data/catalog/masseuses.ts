...
import { assertValidMasseuseCatalog } from './validators';

/** Full night-salon massage menu (same order as ceník / massageService catalog). */
export const ALL_MASSAGE_SLUGS: readonly string[] = [
  'body-to-body-massage',
  'erotic-mix-massage-2',
  'lingam-massage',
  'nuru-massage',
  'pussycat-massage',
  'four-hands-joy-massage',
];
...
export const MASSEUSE_CATALOG: CatalogMasseuse[] = [
  {
    ...
    cardImageObjectPosition: 'center 38%',
    cardImageScale: 1.52,
    galleryUrls: [
    ...
    physical: {
      ...
      languages: ['cs', 'en'],
      hotelEscort: false,
      companionEscort: false,
    },
    offerings: {
      massageSlugs: ['nuru-massage', 'body-to-body-massage', 'lingam-massage'],
      extraSlugs: ['footjob', 'prostate-massage'],
    },
  ...
  },
  {
    ...
    physical: {
      ...
      languages: ['cs', 'en'],
      hotelEscort: true,
      companionEscort: true,
    },
    offerings: {
      massageSlugs: [...ALL_MASSAGE_SLUGS],
      extraSlugs: ['french-kiss', 'tenga-egg', 'autoerotica', 'stripshow', 'footjob'],
    },
    schedule: defaultNightSchedule,
    sortOrder: 20,
  },
  {
    ...
    offerings: {
      massageSlugs: ['four-hands-joy-massage', 'body-to-body-massage', 'nuru-massage'],
      extraSlugs: ['footjob', 'autoerotica', 'prostate-massage'],
    },
    schedule: defaultNightSchedule,
    sortOrder: 30,
  },
  ...
  },
  {
    ...
    offerings: {
      massageSlugs: ['nuru-massage', 'pussycat-massage', 'erotic-mix-massage-2'],
      extraSlugs: ['stripshow', 'tenga-egg', 'autoerotica', 'footjob'],
    },
    schedule: defaultNightSchedule,
    sortOrder: 50,
  },
  {
    ...
    offerings: {
      massageSlugs: ['body-to-body-massage', 'lingam-massage', 'four-hands-joy-massage'],
      extraSlugs: ['french-kiss', 'tenga-egg', 'autoerotica'],
    },
    schedule: defaultNightSchedule,
    sortOrder: 60,
  },
...
assertValidMasseuseCatalog(MASSEUSE_CATALOG);
